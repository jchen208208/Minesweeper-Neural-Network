...
## The CNN Brain — `src/agent/model.py`
...
## The Memory — `src/agent/replay_buffer.py`
...
## The Decision-Maker — `src/agent/agent.py`
...
## The Training Loop — `src/agent/train.py`
...
## Testing the Trained AI — `src/agent/evaluate.py`
...
### 3. Measure it, and try other board sizes
...
## If Learning Stalls — the Tuning Knobs
